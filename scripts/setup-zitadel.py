...
def main():
    ...
    try:
        ...
        print("2. Login with the admin credentials configured in docker-compose.yml")
    ...
    # Write sensitive configuration to file instead of logging to stdout
    env_lines = ["# Generated by setup-zitadel.py\n"]
    env_lines.append("# ontokit-api/.env\n")
    ...
    # Print non-sensitive summary to stdout
    print("\n" + "=" * 60)
    print("Setup Complete!")
    print("=" * 60)
    print(f"\nCredentials written to: {env_file}")
    print("Copy the relevant values into your .env files.")
    print()
