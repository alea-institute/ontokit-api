...
class DistinctEntityDecision(Base):
    """Record that a reviewer marked a canonical IRI pair as distinct.

    Rows are immutable audit snapshots except for revocation and supersession.
    The fingerprints bind the decision to the detector inputs that were
    reviewed, so changed entity content or branch context resurfaces.
    """
